...
export default function CameraController() {
    ...
    useFrame(() => {
        ...
        const object = pointerRef.current.getObject(); // this is a THREE.Object3D

        // move on horizontal plane
        object.position.x += moveX;
        object.position.z += moveZ;

        // update vertical height to follow surface
        object.position.y = f(object.position.x, object.position.z) + CAMERA_HEIGHT;

        // sync personPosition in store
        setPersonPosition([object.position.x, object.position.z]);
    });
